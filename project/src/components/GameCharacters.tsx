...
export default function GameCharacters({ setCharactersView }: GameCharactersProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <h1 className="cyberpunk-heading text-4xl font-bold text-cyber-secondary-500 mb-8">Game Characters</h1>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {gameCharacters.map((character: Character) => (
            <div
                key={character.name}
