...
export default function Navbar({ resetView }: { resetView?: () => void }) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex space-x-8">
            ...
            <Link to="/characters" className="text-red-400 hover:text-cyber-secondary-500 transition-colors cyberpunk-heading" onClick={resetView}>Characters</Link>
